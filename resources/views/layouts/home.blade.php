...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        {{-- temp Stylesheet --}}
        <link rel="stylesheet" href="{{ asset('css/temp_layouts_home.css') }}">
    ...
    <body>
        ...
        <div class="col-md-4">
            ...
            <div class="sections">
                ...
                {{-- Navigation Starts --}}
                    <nav class="navigation navbar navbar-default navbar-fixed-top @can('view dashboard') with-admin-navigation position-initial @endcan">
                        {{-- Navigation Heading --}}
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <img src="{{ asset('images/amio-logo.png') }}" alt="Amaretti">
                            </a>
                            {{-- End Navigation Logo --}}
        ...
        <div class="col-md-8 left-brain">
{{--            <span class="nav-tagline" style="display:block; float:right;margin-top:85px">"People don't buy what you do, they buy why you do it". – Simon Sinek</span>--}}
        </div>
